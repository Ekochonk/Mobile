...
public class Login {
	...
	public void user_click_on_LOGIN_button() {
		Mobile.callTestCase(findTestCase('Pages/Login/Click Button Login'), [:], FailureHandling.STOP_ON_FAILURE)
	}

	@Then("User input registered username only {string}")
	public void user_input_registered_username_only(String username) {
		Mobile.callTestCase(findTestCase('Pages/Login/Input Username'), [('username') : 'standard_user'], FailureHandling.STOP_ON_FAILURE)
